...
# ==========================================================================================
# RESULTS
# | dataset | pred_len | bridge | ffn | test_mse | test_mae | best_val_mse | params | epochs | sec |
# |---|---|---|---|---|---|---|---|---|---|
# | ETTh1 | 96 | cross_attn | half | 0.8371 | 0.6950 | 0.6977 | 7,387,143 | 4 | 101 |
# | ETTh1 | 96 | concat | half | 0.8150 | 0.6868 | 0.6508 | 6,862,343 | 4 | 95 |
# | ETTh1 | 96 | add | half | 0.7366 | 0.6349 | 0.5808 | 6,337,543 | 4 | 88 |
# | ETTh1 | 96 | dot | half | 0.8108 | 0.6797 | 0.6521 | 6,337,543 | 4 | 91 |
# | ETTh1 | 192 | cross_attn | half | 0.8747 | 0.6950 | 0.7949 | 7,387,143 | 4 | 132 |
# | ETTh1 | 192 | concat | half | 0.9205 | 0.7165 | 0.7834 | 6,862,343 | 4 | 123 |
# | ETTh1 | 192 | add | half | 0.9615 | 0.7428 | 0.8001 | 6,337,543 | 4 | 114 |
# | ETTh1 | 192 | dot | half | 1.0051 | 0.7591 | 0.8791 | 6,337,543 | 4 | 117 |
# | ETTh1 | 336 | cross_attn | half | 1.0047 | 0.7529 | 0.9830 | 7,387,143 | 8 | 364 |
# | ETTh1 | 336 | concat | half | 1.0219 | 0.7700 | 0.9625 | 6,862,343 | 4 | 172 |
# | ETTh1 | 336 | add | half | 1.1121 | 0.8140 | 1.0004 | 6,337,543 | 4 | 157 |
# | ETTh1 | 336 | dot | half | 1.0588 | 0.7840 | 0.9419 | 6,337,543 | 5 | 200 |
# | ETTh1 | 720 | cross_attn | half | 0.9280 | 0.7458 | 0.8730 | 7,387,143 | 5 | 403 |
# | ETTh1 | 720 | concat | half | 1.0023 | 0.7619 | 1.0267 | 6,862,343 | 6 | 453 |
# | ETTh1 | 720 | add | half | 0.9741 | 0.7432 | 0.8766 | 6,337,543 | 4 | 272 |
# | ETTh1 | 720 | dot | half | 1.0094 | 0.7735 | 0.9837 | 6,337,543 | 4 | 280 |
# ==========================================================================================
